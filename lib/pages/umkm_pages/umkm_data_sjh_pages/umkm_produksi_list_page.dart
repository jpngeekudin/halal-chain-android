...
class UmkmProduksiListPage extends StatelessWidget {
  const UmkmProduksiListPage({ Key? key }) : super(key: key);

  Future<List<UmkmDocProduksi>> _getProduksiList(BuildContext context) async {
    final logger = Logger();
    try {
      final currentUser = await getUserData();
      final core = CoreService();
      final params = { 'umkm_id': currentUser?.id, 'type': 'produksi' };
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(produksi.id, style: TextStyle(
                  ...
                  return Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(item.namaProduk, style: TextStyle(
                            fontWeight: FontWeight.bold
                          )),
                          SizedBox(height: 5),
                          wrapHorizontal([
                            Icon(Icons.calendar_month, color: Colors.grey[600], size: 12),
                            SizedBox(width: 5),
                            Text(defaultDateFormat.format(item.tanggalProduksi), style: TextStyle(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            ...
            child: FutureBuilder(
              future: _getProduksiList(context),
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder:(context, index) {
                      ...
                      return InkWell(
                        onTap: () => _openDetailModal(context: context, produksi: produksi),
                        child: Container(
                          padding: EdgeInsets.all(20),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(produksi.id, style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              )),
                              SizedBox(height: 10),
