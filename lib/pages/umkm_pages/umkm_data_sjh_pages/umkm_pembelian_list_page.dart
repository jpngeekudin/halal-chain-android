...
class UmkmPembelianListPage extends StatelessWidget {
  const UmkmPembelianListPage({ Key? key, this.typeBahan = 'non-import' }) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  padding: EdgeInsets.all(20),
                  child: Text(pembelian.id, style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          Wrap(
                            ...
                            children: [
                              Text(item.namaDanMerk, style: TextStyle(
                                fontWeight: FontWeight.bold,
                              )),
                              SizedBox(width: 5),
                              Icon(
                                item.halal.toLowerCase() == 'true' ?
                                  Icons.check_circle : Icons.remove_circle,
                          ...
                          SizedBox(height: 5),
                          Text(item.namaDanNegara, style: TextStyle(
  ...
  Future<List<UmkmDocPembelian>> _getPembelianList(BuildContext context) async {
    final logger = Logger();
    try {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: SingleChildScrollView(
            child: FutureBuilder(
              future: _getPembelianList(context),
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder:(context, index) {
                      ...
                      return InkWell(
                        onTap: () => _openDetailModal(context: context, pembelian: pembelian),
                        child: Container(
                          padding: EdgeInsets.all(20),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(pembelian.id, style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              )),
                              SizedBox(height: 10),
