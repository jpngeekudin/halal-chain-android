...
class UmkmAuditInternalListPage extends StatelessWidget {
  const UmkmAuditInternalListPage({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Container(
                  padding: EdgeInsets.all(20),
                  child: Text(audit.id, style: TextStyle(
                  ...
                  child: Container(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        else if (index == audit.data.data.length + 1) return SizedBox(height: 20);
  ...
  Future<List<UmkmAuditInternal>?> _getAuditInternalList(BuildContext context) async {
    final logger = Logger();
    try {
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder:(context, index) {
                      ...
                      return InkWell(
                        onTap: () => _openDetailModal(context: context, audit: audit),
                        child: Container(
                          padding: EdgeInsets.all(20),
                          decoration: BoxDecoration(
