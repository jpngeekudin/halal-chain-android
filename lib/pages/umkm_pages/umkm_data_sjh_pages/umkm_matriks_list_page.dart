...
class UmkmMatriksListPage extends StatelessWidget {
  const UmkmMatriksListPage({ Key? key }) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(matriks.id, style: TextStyle(
                  ...
                  return Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(item.namaBahan, style: TextStyle(
                            fontWeight: FontWeight.bold,
                          )),
                          SizedBox(height: 5),
                          DefaultTextStyle(
  ...
  Future<List<UmkmDocMatriks>> _getMatriksList(BuildContext context) async {
    final logger = Logger();
    try {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: SingleChildScrollView(
            child: FutureBuilder(
              future: _getMatriksList(context),
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder:(context, index) {
                      ...
                      return InkWell(
                        onTap: () => _openDetailModal(context: context, matriks: matriks),
                        child: Container(
                          padding: EdgeInsets.all(20),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(matriks.id, style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              )),
                              SizedBox(height: 10),
